...
const LPDentista = () => {
  ...
  return (
    <div className="lp-dentista">
      ...
      {/* Seção: Exemplos Práticos de Uso (inspirada em \"Exemplos\" do PipClip) */}
      <section className="products-section" id="exemplos">
        <div className="lp-container">
          ...
          <div className="products-grid">
            <div className="product-card">
              ...
              <h3>Laudos Radiográficos Profissionais</h3>
              <p>Relatórios completos, com achados organizados e linguagem clara para dentistas e pacientes.</p>
              <ul className="product-features">
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Mais de 50 achados radiográficos mapeados</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Laudos padronizados para prontuário e convênios</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Geração em poucos minutos</span>
                </li>
              </ul>
            </div>
            ...
            <div className="product-card">
              ...
              <ul className="product-features">
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Orçamentos claros e profissionais para o paciente</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Controle de status: enviado, aprovado, recusado</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Histórico completo de tudo o que foi proposto</span>
                </li>
              </ul>
            </div>
            ...
            <div className="product-card">
              ...
              <h3>Relatórios Financeiros e de Produção</h3>
              <p>Veja em números o impacto da NODON na sua clínica ou consultório.</p>
              <ul className="product-features">
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Receita, ticket médio e margem por procedimento</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Indicadores de crescimento mês a mês</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheckCircle} />
                  <span>Visão simples para decisões rápidas</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Seção: Como Funciona - 3 passos (inspirada em \"3 passos\" do PipClip) */}
      <section className="benefits-section" id="como-funciona">
        <div className="lp-container">
          <div className="section-label">
            <span>COMO FUNCIONA</span>
          </div>
          <h2 className="section-title">3 passos para ter a NODON na sua rotina</h2>
            ...
            <div className="benefit-row benefit-row-left">
              <div className="benefit-content">
                ...
                <div className="benefit-info">
                  ...
                  <h3>Crie sua conta e conecte sua clínica</h3>
                  <p>Em poucos minutos você ativa seu acesso, configura dados básicos e já pode começar a usar.</p>
                </div>
              </div>
            </div>
            ...
            <div className="benefit-row benefit-row-right">
              <div className="benefit-content">
                ...
                <div className="benefit-info">
                  ...
                  <h3>Envie radiografias e pacientes</h3>
                  <p>Traga seus casos para a NODON: radiografias, diagnósticos, orçamentos e agenda.</p>
                </div>
              </div>
            </div>
            ...
            <div className="benefit-row benefit-row-left">
              <div className="benefit-content">
                ...
                <div className="benefit-info">
                  ...
                  <h3>Deixe a IA trabalhar por você</h3>
      ...
      {/* FAQ - Perguntas Frequentes (inspirada na FAQ do PipClip) */}
      <section className="faq-section" id="faq">
        <div className="lp-container">
          <div className="section-label">
            <span>PERGUNTAS FREQUENTES</span>
          </div>
          <h2 className="section-title">Dúvidas antes de começar?</h2>
          <div className="faq-grid">
            <div className="faq-item">
              <div className="faq-icon">
                <FontAwesomeIcon icon={faQuestionCircle} />
              </div>
              <h3>Preciso saber de tecnologia para usar a NODON?</h3>
              <p>Não. A NODON foi feita para dentistas, não para programadores. A interface é simples e guiada, como no PipClip: você entra, usa e vê resultado em poucos minutos.</p>
            </div>
            <div className="faq-item">
              <div className="faq-icon">
                <FontAwesomeIcon icon={faClock} />
              ...
              <p>Nos primeiros dias você já sente ganho de tempo em diagnósticos, orçamentos e organização. Em poucas semanas, a melhoria de receita começa a aparecer nos seus números.</p>
            </div>
            <div className="faq-item">
              <div className="faq-icon">
                <FontAwesomeIcon icon={faShieldAlt} />
              </div>
              <h3>Posso usar os laudos e relatórios comercialmente?</h3>
              <p>Sim. Todos os laudos, orçamentos e relatórios gerados na NODON podem ser usados nos seus atendimentos, prontuários e materiais de apoio ao paciente.</p>
            </div>
            <div className="faq-item">
              <div className="faq-icon">
